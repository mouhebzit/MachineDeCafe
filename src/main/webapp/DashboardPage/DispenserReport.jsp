...
<link rel="stylesheet" href="../DashboardPage/DispenserReport.css" media="screen">
  ...
  <body class="u-body u-xl-mode" data-lang="en"><header class="u-clearfix u-header u-header" id="sec-cd56"><div class="u-clearfix u-sheet u-sheet-1">
    ...
    <section class="u-align-center u-clearfix u-image u-section-1" id="carousel_58cc" data-image-width="1553" data-image-height="1000">
      <div class="u-clearfix u-sheet u-sheet-1">
        <h1 class="u-align-center u-custom-font u-font-raleway u-text u-text-default u-text-1">Dispenser reports<br>
        </h1>
        <p class="u-align-center u-text u-text-default u-text-2">Choose the dispenser to show its reports<br>
        </p>
        <div class="u-expanded-width u-list u-list-1">
          <div class="u-repeater u-repeater-1">

              <c:forEach items="${requestScope.data}" var="report">
              ...
              <div class="u-container-layout u-similar-container u-valign-top u-container-layout-1">
                <div class="u-align-center u-container-style u-expanded-width u-group u-opacity u-opacity-75 u-palette-5-dark-3 u-shape-rectangle u-group-1">
                  <div class="u-container-layout u-valign-middle u-container-layout-2">
                    <h3 class="u-align-center u-custom-font u-font-raleway u-text u-text-default u-text-3">Report ID <c:out value="${report.getReportID()}"/> <br>
                    </h3>
                  </div>
                </div>
                ...
                <div class="u-container-style u-expanded-width u-group u-opacity u-opacity-80 u-palette-5-light-1 u-group-2">
                  <div class="u-container-layout u-valign-middle u-container-layout-3">
                    <p class="u-align-center u-text u-text-default u-text-4">Report date <b><c:out value="${report.getDataTimeOfReport()}"/></b>
                    </p>
                    <ul class="u-align-left u-custom-list u-text u-text-5">
                      <li>
                        ...
                        </div>Report ID <c:out value="${report.getReportID()}"/> <br>
                      </li>
                      <li>
                        <div class="class u-list-icon u-text-black">
                          <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" xml:space="preserve" class="u-svg-content" viewBox="0 0 512.019 512.019" x="0px" y="0px" id="svg-b379" style=""><path fill="currentColor" d="M362.676,0H149.343C119.888,0,96.01,23.878,96.01,53.333v448 c-0.011,5.891,4.757,10.675,10.648,10.686c2.84,0.005,5.565-1.123,7.571-3.134L256.01,367.083l141.781,141.781 c4.16,4.171,10.914,4.179,15.085,0.019c2.006-2.001,3.133-4.717,3.134-7.55v-448C416.01,23.878,392.131,0,362.676,0z"></path></svg>
                        </div>Dispenser id <c:out value="${report.getDispenserStatusId()}"/> <br>
                      </li>
                    </ul>
                    <a href="https://nicepage.com/website-builder" class="u-border-none u-btn u-btn-rectangle u-button-style u-grey-70 u-btn-1">Show more</a>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="u-container-style u-group u-opacity u-opacity-75 u-palette-5-light-1 u-group-7">
          <div class="u-container-layout u-container-layout-10">
            <h1 class="u-align-center u-custom-font u-font-raleway u-text u-text-default u-text-12">Generate new report base on the dispenser status<br>
              <br>
            </h1>
            <a href="<c:url value="/home/GenerateReportByDispenserIdServlet?id="/><c:out value="${requestScope.dispenserId}"/>" class="u-border-none u-btn u-button-style u-grey-70 u-hover-palette-5-light-2 u-btn-4">Generate</a>
          </div>
        </div>
      </div>
    </section>
